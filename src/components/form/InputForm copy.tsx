  ...
  return (
    <Form {...form}>
      ...
      >
                        ...
                        <PopoverTrigger asChild>
                          <FormControl>
                            <Button
                              ...
                              color="orange"
                              className={cn(
                                "flex gap-2 w-full md:w-[240px] pl-3 text-left font-normal border-gray-200 dark:border-gray-700",
                        ...
                        <Select onValueChange={field.onChange} defaultValue={priority}>
                          ...
                          <SelectContent>
                            {priorityData.map((item, idx) => (
                              <SelectItem key={idx} value={item.priority}>
        ...
        <CardFooter className="flex flex-col lg:flex-row lg:justify-end gap-2 border-t-2 dark:border-gray-700 pt-3">
          <div className='flex gap-3'>
            <Button
              className='px-6 border-orange-400! hover:bg-orange-200! hover:border-orange-200! dark:hover:text-black cursor-pointer'
              variant={'outline'}
              onClick={hideModal}
            >
              Cancel
            ...
            <Button
              className='px-6 bg-orange-400 text-white hover:bg-orange-500 cursor-pointer'
              type='submit'
            >
